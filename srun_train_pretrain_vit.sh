...
do
    ...
    do
        ...
        do
            ...
            python main_supcon.py --batch_size 64 --learning_rate ${lr} --epochs 200 --temp 0.1 --dataset path --seed 0 --folder_id ${folderid} --model vit_large_patch16_224.augreg_in21k_ft_in1k  --cosine --pretrain \
